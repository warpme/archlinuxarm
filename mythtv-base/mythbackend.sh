...
# su mythtv -c "/usr/bin/mythbackend --verbose channel --loglevel debug --logpath /tmp/"
# su mythtv -c "/usr/bin/mythbackend --verbose record"
...
#                             This is typically used in combination with --daemon, and if used in combination with --pidfile, this can be used with log
